...
[ $dspi == 'guitarix' ] && (
  jackd -s -S -P80 -p16 -t2000 -dalsa -dhw:pisound,0 -r48000 -p64 -n6 -s -S -D -Xnone >> /home/pi/DSPi/jackboot.log &
  # chrt -a -r -p 80 $! &
  sleep 15
...
[ $dspi == 'amsynth' ] && (
  jackd -s -S -P80 -p16 -t2000 -dalsa -dhw:pisound,0 -r48000 -p64 -n6 -s -S -P -Xnone >> /home/pi/DSPi/jackboot.log &
  # chrt -a -r -p 80 $! &
  sleep 15
